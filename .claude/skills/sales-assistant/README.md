...
**v2 (apr 2026):** добавлены `case-studies/` (готовые продуктовые базы) + `product-templates/` (шаблоны для адаптации под свой продукт) + `advanced-methodologies/` (КВП-скрипт, мульти-голос).
